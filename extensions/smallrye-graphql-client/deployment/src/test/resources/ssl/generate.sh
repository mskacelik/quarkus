...
keytool -genkeypair -validity 3650 -storepass serverkeystorepassword -dname "cn=example.com,ou=server" -storetype PKCS12 -keystore server.pkcs12.keystore -keyalg RSA
...
keytool -genkeypair -validity 3650 -storepass serverwrongkeystorepassword -dname "cn=example.com,ou=serverwrong" -storetype PKCS12 -keystore server.pkcs12.wrong.keystore -keyalg RSA

# client.pkcs12.keystore :: client's keystore
keytool -genkeypair -validity 3650 -storepass clientkeystorepassword -dname "cn=example.com,ou=client" -storetype PKCS12 -keystore client.pkcs12.keystore -keyalg RSA
...
keytool -genkeypair -validity 3650 -storepass clientwrongkeystorepassword -dname "cn=example.com,ou=clientwrong" -storetype PKCS12 -keystore client.pkcs12.wrong.keystore -keyalg RSA